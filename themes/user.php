...
<div class="container-fluid p-5">
    <div class="row">
        <div class="col-4">
            <h5>Formulário de requisição de avaliação</h5>
            <form action="laudoitbi.php" target="_blank" method="post">
                ...
                <div id="demo" class="collapse">
                    ...
                    <div>
                        <button type="button" data-toggle="collapse" data-target="#demo3">Forçar outros dados do imóvel</button>
                    </div>
            ...
            <p>
            <div><br>
                <button data-toggle="collapse" data-target="#demo">MOSTRAR OPÇÕES PARA AVALIAÇÕES ALTERANTIVAS COM ANÁLISE
                    HUMANA
                </button>
            </div>
            <p>
            <div><br>
                <button data-toggle="collapse" data-target="#demo2">EFETUAR EXCLUSÃO DE GUIA DE ITBI DA ANÁLISE</button>
            </div>
            <p></p>
